...
日本自由行的兩種打開方式 —— 看你今天是 J 人還是 P 人。介面與內容支援 中文/English/日本語。
...
排好的行程可以 ✍️ 手動微調(當日排序、跨天移動、手動加點,重骰前會先確認)、
📅 匯出 .ics 行事曆;設了出發日還會逐日顯示 ☀️ 天氣預報(Open-Meteo,16 天內)。
🔍 全站搜尋與 📖 Codex 圖鑑可逛全部 POI、⭐ 收藏的點排程時優先排入。
PWA 離線可用(app shell precache,地圖磚不快取、離線優雅降級)。

## 內容

913 個景點 / 60 個城市 / 9 大地區(東京・關東近郊、關西、北海道、九州、沖繩、中部北陸、中國地方、四國、東北),含約 370 家餐廳咖啡廳、60 份伴手禮清單與交通建議(自駕/大眾運輸)。每個景點含日文原名
